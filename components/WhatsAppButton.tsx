...
const WhatsAppButton: React.FC = () => {
  return (
    <a 
      href="https://wa.me/905366850647" 
      target="_blank" 
      rel="noopener noreferrer"
      className="fixed bottom-8 right-8 z-[100] bg-green-500 text-white p-4 rounded-full shadow-2xl whatsapp-pulse flex items-center justify-center hover:scale-110 transition-transform active:scale-95"
